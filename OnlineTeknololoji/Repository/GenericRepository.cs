...
namespace OnlineTeknololoji.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private teknomarketDB1Entities _DBEntity;
        public GenericRepository(teknomarketDB1Entities DBEntity) 
        {
            _DBEntity = DBEntity;
        ...
        public void RemoveRangeClause(Expression<Func<Tbl_Entity, bool>> wherePredict)
        {
